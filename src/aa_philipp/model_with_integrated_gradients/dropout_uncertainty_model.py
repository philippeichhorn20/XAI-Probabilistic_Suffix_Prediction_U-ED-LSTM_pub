...
class DropoutUncertaintyEncoderDecoderLSTM(nn.Module):
    def __init__(
        ...
        print(
            "Output feature list of dicts (featue name, feature output size) of decoder: ",
            self.output_sizes,
        )
        ...
        print(
            "Output feature list of dicts (featue name, tensor index in dataset) of decoder: ",
            self.output_feature_indeces,
        )
    ...
    def __transform_pred_into_next_event(
        ...
        # Replace num preds with previous target event in case the predicted one is smaller the previous target events one
            ...
            assert suffix is not None, f"Suffix is None"
